"""Technopat Sosyal technical forum username intelligence provider."""
...
class TechnopatProvider(BaseUsernameProvider):
    """Checks Technopat Sosyal XenForo forum community profile."""
    ...
    def url_template(self) -> str:
        return "https://www.technopat.net/sosyal/ara/?q={username}&t=post&o=date"
    ...
    async def _extract_from_html(
        ...
        display_name = og_title.split("|")[0].strip() if og_title else f"{username} (Technopat Sosyal)"
        return ForumProfile(
            username=username,
